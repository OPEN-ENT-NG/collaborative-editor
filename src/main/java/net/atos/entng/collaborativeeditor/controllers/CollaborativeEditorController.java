...
public class CollaborativeEditorController extends MongoDbControllerHelper {
    ...
    public CollaborativeEditorController(EventBus eb, String collection, Container container) {
        ...
        this.etherpadHelper = new EtherpadHelper(collection, config.getString("etherpad-url", null), config.getString("etherpad-api-key", null));
    }
        ...
        UserUtils.getUserInfos(eb, request, new Handler<UserInfos>() {
            ...
            public void handle(final UserInfos user) {
                if (user != null) {
                    ...
                    shareJsonSubmit(request, "notify-collaborativeeditor-shared.html", false, params, "name");
                }
            }
        });
    }
